...
print(lista) #Se muestran todos los elementos de la lista.
...
print(lista[:4]) #Te muestra, desde el principio, hasta el indice que indiques.

print(lista[2:]) #Te muestra, desde donde indiques, hasta el final.

print(lista[-1]) #Puedes usar valores negativos. Comienza por "-1" desde derecha a izquierda.